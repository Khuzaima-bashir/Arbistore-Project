COLORS_CHOICES = ['black', 'silver', 'gray', 'white', 'maroon', 'red', 'purple', 'fuchsia', 'green', 'lime',
                 ...
                 'coral', 'cornsilk', 'crimson', 'cyan', 'darkblue', 'darkcyan',
                 ...
                 'wheat', 'white', 'whitesmoke', 'yellow', 'yellowgreen', 'rhubarb', 'moss', 'morello', 'vineyard',
                 'hush', 'sea', 'peony', 'platinum', 'marl', 'stone', 'charcoal', 'trooper', 'balmoral', 'marine',
                 'carbon', 'sandstone', 'shadow', 'sulphur', 'spring', 'sky']
